...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>PHILTHEO</b>-POS</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="upload/<?php echo $_SESSION['IMG']; ?>" class="img-circle" width="40px" height="40px" alt="User Image">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="order.php"><i class="fa fa-circle-o"></i>Processed Orders</a></li>
            <li><a href="orderchange.php"><i class="fa fa-circle-o"></i>Pending Orders</a></li>
            <li><a href="addorder.php"><i class="fa fa-circle-o"></i>Stock</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Employee(Staff)</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          ...
          <ul class="treeview-menu">
            <li><a href="registration.php"><i class="fa fa-circle-o"></i>Add Employee</a></li>
            <li><a href="register.php"><i class="fa fa-circle-o"></i>Edit Employee</a></li>
            <li><a href="Editimage.php"><i class="fa fa-circle-o"></i>Edit User Image</a></li>
          </ul>
        </li>
...
<!--         
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Register</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          ...
          <ul class="treeview-menu">
            <li><a href="viewregister.php"><i class="fa fa-circle-o"></i>Delivery</a></li>
            <li><a href="blank.php"><i class="fa fa-circle-o"></i>Edit Employee</a></li>
          </ul>
        </li> -->
